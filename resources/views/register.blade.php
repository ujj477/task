          ...
          <div class="flex-center position-ref full-height">
           ...
           <!--   @if (Route::has('login'))
            ...
            <div class="content">
                ...
                <div class="links">
                     <form class="kt-form" action="{{url('/saveRegister')}}" method="post">
                                    ...
                                    <div class="input-group">
                                     ...
                                     <div class="input-group">
                                        <label>Bio:</label>
                                        <input class="form-control" type="text" placeholder="Bio-Data" name="bio" autocomplete="off">

                                    </div><br/><br/>

                                   
                                    <div class="kt-login__actions">
                                        <button id="kt_login_signin_submit" class="btn btn-brand btn-pill kt-login__btn-primary">Register</button>
                                    </div>
                                </form>
                </div>
            </div>
